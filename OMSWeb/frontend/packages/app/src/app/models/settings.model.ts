...
const defaultControlTable = {
  ...
  buffers_alertPassedTime: true,
  buffers_carrierEmptyStatus: true,
  buffers_installed: true,
  ...
  buffers_order: [
    ...
    { name: 'buffers_point', i18nLabel: 'names.point', width: 50 },
    ...
    { name: 'buffers_unuse', i18nLabel: 'names.unuse', width: 50 },
    { name: 'buffers_carrierId', i18nLabel: 'names.carrierId', width: 50 },
    ...
    { name: 'buffers_alertPassedTime', i18nLabel: 'names.alertPassedTime', width: 80 },
    { name: 'buffers_carrierEmptyStatus', i18nLabel: 'names.carrierEmptyStatus', width: 80 },
    { name: 'buffers_installed', i18nLabel: 'names.installed', width: 80 }
  ],
