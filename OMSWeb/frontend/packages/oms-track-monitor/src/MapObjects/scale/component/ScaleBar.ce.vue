...
const scaleAtLineMaxLength = computed(
  () => LineMaxLength * scaleInfo.value.mmPerPixel
)
const unit = computed(
  () => Units.find((level) => scaleAtLineMaxLength.value < level) as number
)
