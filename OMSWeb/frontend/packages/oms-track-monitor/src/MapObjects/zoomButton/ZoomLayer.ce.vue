...
<template>
  <div>
    <svg @click="zoomByButton('In')" clip-rule="evenodd" fill-rule="evenodd"
         style="cursor: pointer;"
         stroke-linejoin="round"  stroke-miterlimit="2" width="24" height="24" 
    ...
    <svg @click="zoomByButton('Out')" clip-rule="evenodd" fill-rule="evenodd"
         style="cursor: pointer;"
         stroke-linejoin="round" stroke-miterlimit="2" width="24" height="24" 
         xmlns="http://www.w3.org/2000/svg">
