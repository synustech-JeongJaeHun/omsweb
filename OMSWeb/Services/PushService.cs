  ...
  public class PushService
  {
    ...
    public PushService(IHubContext<OMSHub> hub, CacheService cacheSvc, TrackService trackSvc)
    {
      ...
      this.tableEventMap = new Dictionary<string, DataChangeEventTarget> {
        ...
        {"zcus", new DataChangeEventTarget(CacheKeys.Zcus, new[]{"zcuMapChanged", "zcuStatusChanged"}, true)},
        {"zcu_status", new DataChangeEventTarget(CacheKeys.ZcuStatus, new[]{"zcuMapChanged", "zcuStatusChanged"}, true)},
      ...
      this.cacheEventMap = new Dictionary<CacheKeys, string[]> {
        ...
        {CacheKeys.Zcus, new[]{"zcuMapChanged", "zcuStatusChanged"}},
        {CacheKeys.ZcuStatus, new[]{"zcuMapChanged", "zcuStatusChanged"}},
