  ...
  public class PushService
  {
    ...
    public PushService(IHubContext<OMSHub> hub, CacheService cacheSvc, TrackService trackSvc)
    {
      ...
      this.tableEventMap = new Dictionary<string, DataChangeEventTarget> {
        ...
        {"zcus", new DataChangeEventTarget(CacheKeys.Zcus, new[]{"zcuMapChanged", "zcuStatusTableChanged"}, true)},
        {"zcu_status", new DataChangeEventTarget(CacheKeys.ZcuStatus, new[]{"zcuMapChanged", "zcuStatusTableChanged"}, true)},
      ...
      this.cacheEventMap = new Dictionary<CacheKeys, string[]> {
        ...
        {CacheKeys.Zcus, new[]{"zcuMapChanged", "zcuStatusTableChanged"}},
        {CacheKeys.ZcuStatus, new[]{"zcuMapChanged", "zcuStatusTableChanged"}},
