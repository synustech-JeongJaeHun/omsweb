...
namespace OMSWeb.Services
{
    public class UserService
    {
        ...
        public TokenResponse Authenticate(string userId, string password)
        {
            ...
            lock (_lock)
            {
                verified = VerifySHA256(password, user.Password);
            }
        ...
        private bool VerifySHA256(string input, string userPWD)
        {
            string inputHash = ComputeSHA256(input);
            return inputHash == userPWD;
        }
        ...
        {   
            accountFormDto.Password = ComputeSHA256(accountFormDto.Password);
        ...
        public int UpdateUserByProfile(ProfileFormDto profileFormDto)
        {
            ...
            {
                profileFormDto.NewPassword = ComputeSHA256(profileFormDto.NewPassword);
            }
