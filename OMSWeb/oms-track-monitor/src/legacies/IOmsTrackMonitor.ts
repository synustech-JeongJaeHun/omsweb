...
import { IMapConfigChangeEvent, IMapToolbarCommandEvent, IMapToolbarToggleEvent } from "./models/drawing.model";
...
interface IOMSTrackMonitor {
  ...
  applyAfterSnapshotUpdated: (updatedPropList?: { [id: number]: any }) => void,
