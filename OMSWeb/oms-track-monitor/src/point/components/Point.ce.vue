...
function eventPropagationTestLeft(event: MouseEvent) {
  alert(`LEFT POINT CLICKED ${props.point.logicalId}`)
}
function eventPropagationTestRight(event: MouseEvent) {
  alert(`RIGHT POINT CLICKED ${props.point.logicalId}`)
}
</script>
