...
const arcToWithRadius = (to: Position, sweepFlag: SweepFlag) =>
  ...
  const nextCommands = (function () {
    ...
    switch (typePattern) {
      ...
      case 'D EA2 D': {
        ...
        return [
          lineTo(p1),
          arcToWithRadius(p2, 'CounterClock'),
          lineTo(endPos),
        ]
      }
      ...
      case 'D EC4 D EC3 D': {
        ...
        return [
          lineTo(p1),
          arcToWithRadius(p2, 'Clock'),
          lineTo(p3),
          arcToWithRadius(p4, 'Clock'),
          lineTo(endPos),
        ]
      }
      ...
      case 'D EA3 D EA4 D': {
        ...
        return [
          ...
          arcToWithRadius(p2, 'CounterClock'),
          lineTo(p3),
          arcToWithRadius(p4, 'CounterClock'),
          lineTo(endPos),
        ]
      }
