...
@Component({
  selector: 'oms-systeminfo-reports',
  templateUrl: './systeminfo-report.component.html',
  styles: [
    `
      #systeminfo-report-page {
...
export class SystemInfoReportComponent implements OnInit {
